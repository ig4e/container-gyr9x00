...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gyr9x00.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gyr9x00.containers.anotherwebservice.com/
...
```
git clone git@github.com:ig4e/container-gyr9x00.git
cd container-gyr9x00
```
...
```
docker attach container-gyr9x00
```
